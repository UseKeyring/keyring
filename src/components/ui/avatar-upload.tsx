...
/*
 * Avatar upload button — hover overlay on the current avatar, uploads to
 * the "Avatars" storage bucket and returns the public URL. Shared by the
 * organization logo field and personal account settings; only the storage
 * path prefix and noun differ.
 */
