...
import { Separator } from '@keyring/ui/components/separator'
import { Sheet, SheetContent } from '@keyring/ui/components/sheet'
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from '@keyring/ui/components/tooltip'
import { useIsMobile } from '@keyring/ui/hooks/use-mobile'
...
const SidebarTrigger = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <SolarIcon name="sidebar" className="h-4 w-4" />
